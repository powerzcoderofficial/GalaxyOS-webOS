export default {
  ...
  strings: {
    en_US: {
      ...
      welcome_page1_header: "Welcome!",
      welcome_page1_body:
        "Hey there! Welcome to Galaxy!\n\nPress Next to enter setup.",
      ...
      welcome_page4_header: "You're system is now ready to use!",
      welcome_page4_body:
        "Press the Finish button to exit the setup and save your settings.",
    },
    en_GB: {
      welcome_window_title: "Welcome",
      welcome_page1_header: "Welcome!",
    ...
    de_DE: {
      ...
      welcome_page1_header: "Willkommen!",
      welcome_page1_body:
        'Hallo! Wilkommen bei Galaxy!\n\nDrücken Sie "Nächste Seite" um die Einstellungen zu öffnen',
    ...
    es_ES: {
      ...
      welcome_page1_header: "Bienvenido!",
      welcome_page1_body:
        "¡Hola! Bienvenido a Galaxy!\n\nPresione Siguiente para ingresar la configuración.",
    ...
    pt_BR: {
      ...
      welcome_page1_header: "Bem-vindo!",
      welcome_page1_body:
        "Ola! Bem-vindo a Galaxy!\n\nPressione o próximo para entrar na instalação.",
