export default {
    name: "Terminal",
    description: "A simple command Processor",
    ...
    exec: async (Root) => {
      ...
      let Terminal = new Html("div")
        .class("no-ui")
        .html(
          /*html*/ `<div><div class="output">&copy Clantum Studios. All Rights Reserved.<br>Enter 'js' to switch to JavaScript and 'help' to get a list of commands.<br></div></div><div class="userInput"><div style="display:flex;" id="inputDiv"><span class="prompt">${Term.prompt}</span><div class="none input" contenteditable="true"></div></div></div>`
        );
